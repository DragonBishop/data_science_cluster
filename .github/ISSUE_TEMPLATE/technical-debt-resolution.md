...
about: Identifies a source of technical debt and proposes a solution
title: 'Debt: '
labels: techdebt
assignees:
...
### Technical Notes
*Drop in any relevant file paths, scripts, or links to documentation you will need when you start coding.*
